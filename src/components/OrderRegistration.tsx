...
export default function OrderRegistration() {
  ...
  const handleClientChange = (clientId: string) => {
    ...
    setFormData({
      ...formData,
      clientId,
      pickupLocation: client?.clientAddress || ''
    });
  };
            ...
            <div className="p-8 md:p-10 space-y-10">
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    <label className="text-sm font-semibold text-neutral-700 ml-1">Outsource Charges</label>
                    <input 
                      type="number"
                      value={formData.outsourceCharges}
                      onChange={(e) => setFormData({...formData, outsourceCharges: parseFloat(e.target.value) || 0})}
                      className="w-full px-4 py-3 bg-neutral-50 border border-neutral-200 rounded-2xl focus:ring-2 focus:ring-indigo-500 outline-none"
                    />
                  </div>
                  <div className="space-y-2">
                    <label className="text-sm font-semibold text-neutral-700 ml-1">Delivery Charges</label>
                    <input 
                      required
                      type="number"
            ...
            {latestOrders.map((order) => (
              ...
              >
                ...
                <div className="flex justify-between items-center pt-3 border-t border-neutral-50">
                  <span className="text-xs font-medium text-neutral-400">{order.clientName}</span>
